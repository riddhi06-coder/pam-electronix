                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('product-specifications.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="name" type="text" name="name" placeholder="Enter Name" value="{{ old('name', $details->name) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="manufacturer" type="text" name="manufacturer" placeholder="Enter Manufacturer" value="{{ old('manufacturer', $details->manufacturer) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="availability" type="text" name="availability" placeholder="Enter Stock Availability" value="{{ old('availability', $details->availability) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="rohs" type="text" name="rohs" placeholder="Enter RoHS" value="{{ old('rohs', $details->rohs) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="termination" type="text" name="termination" placeholder="Enter Termination Style" value="{{ old('termination', $details->termination) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="pf" type="text" name="pf" placeholder="Enter PF" value="{{ old('pf', $details->pf) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="lead_spacing" type="text" name="lead_spacing" placeholder="Enter Lead Spacing" value="{{ old('lead_spacing', $details->lead_spacing) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="lead_wire" type="text" name="lead_wire" placeholder="Enter Lead wire Diameter" value="{{ old('lead_wire', $details->lead_wire) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="tolerance" type="text" name="tolerance" placeholder="Enter Tolerance" value="{{ old('tolerance', $details->tolerance) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="operating_temp" type="text" name="operating_temp" placeholder="Enter Minimum Operating Temperature" value="{{ old('operating_temp', $details->operating_temp) }}" >
                                        ...
                                        <!-- Maximum Operating Temperature---->
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="max_operating_temp" type="text" name="max_operating_temp" placeholder="Enter Maximum Operating Temperature" value="{{ old('max_operating_temp', $details->max_operating_temp) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="series" type="text" name="series" placeholder="Enter Series" value="{{ old('series', $details->series) }}" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="qualification" type="text" name="qualification" placeholder="Enter Qualification" value="{{ old('qualification', $details->qualification) }}" >
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="packaging" type="text" name="packaging" placeholder="Enter Packaging" value="{{ old('packaging', $details->packaging) }}" >
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control summernote" id="summernote" name="product_description" placeholder="Enter Product Name" >{{ old('product_description', $details->product_description) }}</textarea>

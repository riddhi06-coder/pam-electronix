                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <!-- Fixed Product Display -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="pricing" type="string" name="pricing" placeholder="Enter Pricing" value="{{ old('pricing') }}"  min="0" step="any">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="capacitance" type="string" name="capacitance" placeholder="Enter Capacitance" value="{{ old('capacitance') }}"  min="0" step="any">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="voltage" type="string" name="voltage" placeholder="Enter Voltage" value="{{ old('voltage') }}"  min="0" step="any">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="length" type="string" name="length" placeholder="Enter Length" value="{{ old('length') }}"  min="0" step="any">
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="width" type="string" name="width" placeholder="Enter Width" value="{{ old('width') }}"  min="0" step="any">
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="height" type="string" name="height" placeholder="Enter Height" value="{{ old('height') }}"  min="0" step="any">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="package_case" type="string" name="package_case" placeholder="Enter Package/Case IN PLASTIC BAG" value="{{ old('package_case') }}"  min="0" step="any">

        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Product Description Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('product-descriptions.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <!-- Preview Section -->
                                        <div class="col-md-12" id="productImagePreviewContainer" style="display: none;">
                                            <img id="product_image_preview" src="" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="voltage_heading" type="text" name="voltage_heading" placeholder="Enter Heading" value="{{ old('voltage_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="voltage_description" name="voltage_description" placeholder="Enter Description" required>{{ old('voltage_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="operating_heading" type="text" name="operating_heading" placeholder="Enter Heading" value="{{ old('operating_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="operating_description" name="operating_description" placeholder="Enter Description" required>{{ old('operating_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="marking_heading" type="text" name="marking_heading" placeholder="Enter Heading" value="{{ old('marking_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="marking_description" name="marking_description" placeholder="Enter Description" required>{{ old('marking_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="ordering_heading" type="text" name="ordering_heading" placeholder="Enter Heading" value="{{ old('ordering_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12" id="ImagePreviewContainer" style="display: none;">
                                            <img id="image_preview" src="" alt="Preview" class="img-fluid" style="max-height: 300px; border: 1px solid #ddd; padding: 5px;">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="style_heading" type="text" name="style_heading" placeholder="Enter Heading" value="{{ old('style_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="style_description" name="style_description" placeholder="Enter Description" required>{{ old('style_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="characteristics_heading" type="text" name="characteristics_heading" placeholder="Enter Heading" value="{{ old('characteristics_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="characteristics_description" name="characteristics_description" placeholder="Enter Description" required>{{ old('characteristics_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="leads_heading" type="text" name="leads_heading" placeholder="Enter Heading" value="{{ old('leads_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="leads_description" name="leads_description" placeholder="Enter Description" required>{{ old('leads_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="special_heading" type="text" name="special_heading" placeholder="Enter Heading" value="{{ old('special_heading') }}" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="special_description" name="special_description" placeholder="Enter Description" required>{{ old('special_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input class="form-control" id="special_image" type="file" name="special_image" accept=".jpg, .jpeg, .png, .webp" required onchange="previewSpecialImage()">
                                            <div class="invalid-feedback">Please upload a Image.</div>
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                            <br>
                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
                                        ...
                                        <!-- Preview Section -->
                                        <div class="col-md-12" id="specialImagePreviewContainer" style="display: none;">
                                            <img id="special_image_preview" src="" alt="Preview" class="img-fluid" style="max-height: 300px; border: 1px solid #ddd; padding: 5px;">
                                        </div>

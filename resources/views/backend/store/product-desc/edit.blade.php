                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('product-descriptions.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                       ...
                                       <!-- Product Name Dropdown -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="capacitance_range_heading" type="text" name="capacitance_range_heading" placeholder="Enter Heading" value="{{ old('capacitance_range_heading', $details->capacitance_range_heading) }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="capacitance_range_description" name="capacitance_range_description" placeholder="Enter Description" required>{{ old('capacitance_range_description', $details->capacitance_description) }}</textarea>

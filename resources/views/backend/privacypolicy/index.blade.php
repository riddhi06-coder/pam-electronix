                                    ...
                                    <tbody>
                                        @foreach($policyDetails as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('manage-privacy-policy.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                    <form action="{{ route('manage-privacy-policy.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')

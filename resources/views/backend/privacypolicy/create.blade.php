        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Privacy Policy Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('privacy-policy.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-md-6 ">
                                        <label class="form-label" for="Terms_title">Privacy Policy Description <span class="txt-danger">*</span></label>
<textarea class="form-control" id="summernote" name="banner_title" placeholder="Enter Terms & Conditions Description" required></textarea>
                                        <div class="invalid-feedback">Please enter a Privacy Policy Description .</div>
                                    </div>
                                    
                                    <!-- Form Actions -->
                                    <div class="col-12 text-end">
                                        <a href="{{ route('privacy-policy.index') }}" class="btn btn-danger px-4">Cancel</a>
